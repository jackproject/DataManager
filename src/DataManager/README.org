...
* nextstep
** DONE 测试
   - State "DONE"       from ""           [2016-05-17 周二 19:38]
   CLOCK: [2016-05-17 周二 19:05]--[2016-05-17 周二 19:38] =>  0:33

1. Goto 限制最大值
2. 分页按钮的手势图标

** DONE 跳转页面
   - State "DONE"       from ""           [2016-05-16 周一 23:11]
** DONE 实现筛选页面功能
   - State "DONE"       from ""           [2016-05-16 周一 23:11]
   CLOCK: [2016-05-16 周一 21:56]--[2016-05-16 周一 22:50] =>  0:54
   CLOCK: [2016-05-16 周一 20:47]--[2016-05-16 周一 21:21] =>  0:34


关于筛选页面固定的字段的问题，我周二晚之前可以修改好。
...
** DONE 512调整
   - State "DONE"       from ""           [2016-05-16 周一 23:11]
   CLOCK: [2016-05-15 周日 21:51]--[2016-05-15 周日 22:10] =>  0:19
   CLOCK: [2016-05-13 周五 19:27]--[2016-05-13 周五 19:49] =>  0:22
   CLOCK: [2016-05-13 周五 19:08]--[2016-05-13 周五 19:27] =>  0:19
...
2、对数据进行筛选时，对显示的字段内容作如下处理

（1）要显示的基本字段：日期、报告编号、工程名称、委托单位
（2）其他需显示的内容根据“查询条件“中选定的内容显示。
...
"全部数据" 一页是否需要显示全部数据？ 还是仅仅只显示规定的一部分？


** DONE 界面调整
   - State "DONE"       from ""           [2016-05-17 周二 19:05]
